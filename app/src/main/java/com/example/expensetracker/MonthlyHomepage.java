...
public class MonthlyHomepage extends Fragment implements Animation.AnimationListener {
    Spinner spinner;
    ...
    {
        View view = inflater.inflate(R.layout.monthlyhomepage,container,false);
        ...
        mLinearLayout = view.findViewById(R.id.linearLayout4);
...
public void calculation()
{
    ...
    String query = "Select * from IncomeDB where UniqueID ='"+UniqueID+"' and month ='"+month_index+"'and year ='"+year+"'";
