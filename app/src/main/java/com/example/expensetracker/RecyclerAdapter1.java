...
class RecyclerAdapter1 extends RecyclerView.Adapter<RecyclerAdapter1.ViewHolder> {
    Context context;
    ArrayList<Values_Transaction> value_array;

    public RecyclerAdapter1(FragmentActivity activity, ArrayList<Values_Transaction> value_array) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.recycleradapter1, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            t2 = view.findViewById(R.id.t22);
            t3 = view.findViewById(R.id.t33);
            t4 = view.findViewById(R.id.t44);
            t5=view.findViewById(R.id.t55);
