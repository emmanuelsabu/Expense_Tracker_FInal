...
class RecyclerAdapter3 extends RecyclerView.Adapter<RecyclerAdapter3.ViewHolder>
{
    ...
    public RecyclerAdapter3(Context context, ArrayList<Values_Transaction> value_array)
    {
    ...
    {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.recycleradapter3,parent,false);
